...
def recipe_image_file_path(instance, filename):
    ...
    # uploads/recipe/xxxx-xxxx-xxxx-xxxx.jpeg
...
class Recipe(models.Model):
    ...
    user = models.ForeignKey(
        # foreign key allows us to set up a relationship between this
        # recipe model and another model.
    ...
    # nested
    tags = models.ManyToManyField('Tag')  # ManyToManyField
